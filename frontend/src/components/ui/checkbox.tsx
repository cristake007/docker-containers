  ...
  return (
    ...
    >
      <CheckboxPrimitive.Indicator
        ...
        className="grid place-content-center text-current [&>svg]:size-3.5 data-[starting-style]:animate-in data-[starting-style]:zoom-in-50 data-[starting-style]:fade-in-0 data-[ending-style]:animate-out data-[ending-style]:zoom-out-50 data-[ending-style]:fade-out-0"
      >
        <CheckIcon
        />
      </CheckboxPrimitive.Indicator>
